...
Aujourd'hui, le terme d'IA est largement utilisé pour désigner des dispositifs de calcul allant de simples algorithmes à des systèmes plus complexes basés sur du des technologies de deep learning. Afin de donner une définition large et opérationnelle de l'IA nous définissons ce terme comme un "agent de calcul", en considérant toutes les techniques qui, par le biais d’un calcul automatisé, produisent un résultat à partir de n'importe quel type de données. Cette définition large nous permet de comprendre comment les acteurs eux-mêmes définissent ces technologies et les relient à une pluralité d'activités et d'entités socio-techniques sans juger (Seaver, 2017)
