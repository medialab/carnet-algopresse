...
<GraphBlock 
  ...
  title={'Semantic network annotated by type of technology related to robots, algorithms or undetermined'} 
  legend={'2991 nodes, 54062 links of cooccurrences, cluster colors related to technology tags, node size related to term frequency '}
/>
...
<GraphBlock 
  ...
  displayAllLabels={true}
  colorPalette={{"Robot":"#fa1633","Algo":"#992ef6","Intermed":"#a39f9f"}}
  title={'Filtering of the network related to algorithm technologies'} 
  legend={'cluster colors related to technology tags'}
/>
...
<GraphBlock 
  ...
  displayAllLabels={true}
  colorPalette={{"Robot":"#fa1633","Algo":"#992ef6","Intermed":"#a39f9f"}}
  title={'Filtering of the network related to robot technologies'} 
  legend={'cluster colors related to technology tags'}
/>
...
<GraphBlock 
  ...
  displayAllLabels={true}
  colorPalette={{"Robot":"#fa1633","Algo":"#992ef6","Intermed":"#a39f9f"}}
  title={'Filtering of the network related to undetermined technologies'} 
  legend={'cluster colors related to technology tags'}
/>
