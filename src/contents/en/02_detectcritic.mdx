...
<LinearGraphBlock 
  ...
  legend={'Fréquence en % des articles critiques et non critiques détectés par le modèle validés manuellement'} 
  normalizeY={true}
/>
...
---
## Method: Use of supervised learning to detect criticism
