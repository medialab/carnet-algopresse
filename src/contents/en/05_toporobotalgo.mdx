...
<GraphBlock 
  ...
  colorPalette={{"Robot":"#fa1633","Algo":"#992ef6","Intermed":"#a39f9f"}}
  title={'Semantic network of the content of critic articles about AI'} 
  legend={'Filtering by meta-cluster "algorithms"'}
/>
...
<GraphBlock 
  ...
  colorPalette={{"Robot":"#fa1633","Algo":"#992ef6","Intermed":"#a39f9f"}}
  title={'Semantic network of the content of critic articles about AI'} 
  legend={'Filtering by meta-cluster "robots"'}
/>
...
<GraphBlock 
  ...
  colorPalette={{"Robot":"#fa1633","Algo":"#992ef6","Intermed":"#a39f9f"}}
  title={'Semantic network of the content of critic articles about AI'} 
  legend={'Filtering by meta-cluster "intermediate"'}
/>
...
<GraphBlock 
  ...
  title={'Semantic network of the content of critic articles about AI'} 
  legend={'Filtering by meta-clusters "algorithms" and "robots"'}
/>
...
<h2>Method: Division of the network and the corpus based on the topology</h2>
...
<ul>
<li>9 clusters</li>
<li>52% of corpus articles (with each article being associated with a single cluster)</li>
</ul>
...
<ul>
<li>14 clusters</li>
<li>48% of corpus articles (with each article being associated with a single cluster)</li>
</ul>
</div>