...
<LinearGraphBlock 
  ...
  yVariable={'value'} 
  colorVariable={'topic'} 
  colorPalette={{"Web_Algorithms":"#4ea46d","Future_of_AI":"#f781c7","Job_Automation":"#a3c45b","Killer_Robots":"#0099f2","Facial_Recognition":"#eaea80","Voice_Assistant":"#b99c34","Autonomous_Cars":"#c5863a","Sex_Robots":"#ffa076","Health_Algorithms":"#31d3ff","Deepfake":"#fe7a7d","Predictive_Algorithms":"#00b6af","Chatbot":"#fae4a2","Game_&_Education":"#f5c2ff","Profiling_Algorthms":"#859b56","Robo-Advisers":"#b6f3ce","Scientific_Research":"#6b9e7d","Market_&_Prices":"#9d9567","Image_Search":"#ffb8ba"}}
/>
